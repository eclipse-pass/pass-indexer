...
public class FedoraMessageConverterTest {
    ...
    public void testConvertCreated() {
        String jms_text_msg = "{\n" +
                              "    \"id\": \"http://fcrepo:8080/fcrepo/rest/grants/30/46/79/7e/3046797e-227c-4da0" +
                              "-ae95-e1828561ca5f\",\n" +
                              "    \"type\": [\n" +
                              ...
                              "            \"name\": \"Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, " +
        ...
        assertEquals("http://fcrepo:8080/fcrepo/rest/grants/30/46/79/7e/3046797e-227c-4da0-ae95-e1828561ca5f",
                     m.getResourceURI());
    ...
    public void testConvertModified() {
        String jms_text_msg = "{\n" +
                              "    \"id\": \"http://fcrepo:8080/fcrepo/rest/submissions/7f/cc/6f/c5/7fcc6fc5-10c8" +
                              "-476d-b537-cf13f20d9be7\",\n" +
                              "    \"type\": [\n" +
                              "        \"http://www.w3.org/ns/ldp#Container\",\n" +
        ...
        assertEquals("http://fcrepo:8080/fcrepo/rest/submissions/7f/cc/6f/c5/7fcc6fc5-10c8-476d-b537-cf13f20d9be7",
                     m.getResourceURI());
    ...
    public void testConvertDeleted() {
        String jms_text_msg = "{\n" +
                              "    \"id\": \"http://fcrepo:8080/fcrepo/rest/people/bc/1b/6a/e5/bc1b6ae5-f252-4402" +
                              "-aa3a-c240b4c55b40\",\n" +
                              "    \"type\": [\n" +
                              "        \"http://www.w3.org/ns/ldp#Container\",\n" +
        ...
        assertEquals("http://fcrepo:8080/fcrepo/rest/people/bc/1b/6a/e5/bc1b6ae5-f252-4402-aa3a-c240b4c55b40",
                     m.getResourceURI());
